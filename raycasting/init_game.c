...
/*   Updated: 2023/12/09 14:07:34 by arahmoun         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	set_animation(t_game *game)
{
	...
	succes = ft_strdup("texture/start/01.xpm|texture/start/02.xpm|"
			"texture/start/03.xpm|texture/start/04.xpm|"
			"texture/start/05.xpm|texture/start/06.xpm|"
			"texture/start/07.xpm|texture/start/08.xpm|"
			"texture/start/09.xpm|texture/start/10.xpm|"
			"texture/start/11.xpm|texture/start/12.xpm|"
			"texture/start/13.xpm|texture/start/14.xpm|"
			"texture/start/15.xpm|texture/start/16.xpm|"
			"texture/start/17.xpm|texture/start/18.xpm|"
			"texture/start/19.xpm|texture/start/20.xpm|"
			"texture/start/21.xpm|texture/start/22.xpm|"
			"texture/start/23.xpm|texture/start/24.xpm|"
			"texture/start/25.xpm|texture/start/26.xpm|"
			"texture/start/27.xpm|texture/start/28.xpm|"
			"texture/start/29.xpm|texture/start/30.xpm|"
			"texture/start/31.xpm|texture/start/32.xpm|"
	...
	succes = ft_strjoin(succes, utils_animation(game));
